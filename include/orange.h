...
namespace orange {
    ...
    class Drivetrain {
        ...
        public:
            ...
            Drivetrain(orange::gearboxType gearbox, vex::motor_group left, vex::motor_group right);
            Drivetrain(orange::gearboxType gearbox, vex::motor_group left, vex::motor_group right, vex::rotation odom);
            Drivetrain();
    }
}
